A Terraform/CX as Code remote module for the following Salesforce API operation: Create Case
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/salesforce-create-case-data-action-module.git?ref=v1.0.0"
